...
export const PowerpointIcon: FC<PropsWithClassName> = ({ className }) => (
  <svg className={className} viewBox="60 78.75 581.25 562.5">
    <defs>
      <radialGradient
        id="pp_b"
        cx="0"
    ...
    <path
      ...
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_a)' }}
    />
    <path
      d="M641.2 360c0-155.332-125.907-281.25-281.223-281.25C204.66 78.75 78.75 204.668 78.75 360s125.91 281.25 281.227 281.25c155.316 0 281.222-125.918 281.222-281.25Zm0 0"
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_b)' }}
    />
    <path
      d="M641.2 360c0-155.332-125.907-281.25-281.223-281.25C204.66 78.75 78.75 204.668 78.75 360s125.91 281.25 281.227 281.25c155.316 0 281.222-125.918 281.222-281.25Zm0 0"
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_c)' }}
    />
    <path
      ...
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_d)' }}
    />
    <path
      d="M360.016 78.75c155.312.004 281.218 125.922 281.218 281.25 0 51.672-13.96 100.07-38.273 141.68l4.57-10.121c27.832-61.797-17.406-131.727-85.183-131.676l-111.93.086c-27.824.023-50.402-22.535-50.402-50.36V197.477c-.004-67.805-70.012-112.993-131.793-85.067l-8.996 4.074c41.406-23.992 89.492-37.734 140.789-37.734Zm0 0"
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_e)' }}
    />
    <path
      d="M360.016 78.75c155.312.004 281.218 125.922 281.218 281.25 0 51.672-13.96 100.07-38.273 141.68l4.57-10.121c27.832-61.797-17.406-131.727-85.183-131.676l-111.93.086c-27.824.023-50.402-22.535-50.402-50.36V197.477c-.004-67.805-70.012-112.993-131.793-85.067l-8.996 4.074c41.406-23.992 89.492-37.734 140.789-37.734Zm0 0"
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_f)' }}
    />
    <path
      d="M360.016 78.75c155.312.004 281.218 125.922 281.218 281.25 0 51.672-13.96 100.07-38.273 141.68l4.57-10.121c27.832-61.797-17.406-131.727-85.183-131.676l-111.93.086c-27.824.023-50.402-22.535-50.402-50.36V197.477c-.004-67.805-70.012-112.993-131.793-85.067l-8.996 4.074c41.406-23.992 89.492-37.734 140.789-37.734Zm0 0"
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_g)' }}
    />
    <path
      d="M360.016 78.75c155.312.004 281.218 125.922 281.218 281.25 0 51.672-13.96 100.07-38.273 141.68l4.57-10.121c27.832-61.797-17.406-131.727-85.183-131.676l-111.93.086c-27.824.023-50.402-22.535-50.402-50.36V197.477c-.004-67.805-70.012-112.993-131.793-85.067l-8.996 4.074c41.406-23.992 89.492-37.734 140.789-37.734Zm0 0"
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_h)' }}
    />
    <path
      ...
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_i)' }}
    />
    <path
      d="M108.75 345h142.5c26.926 0 48.75 21.824 48.75 48.75v142.5c0 26.926-21.824 48.75-48.75 48.75h-142.5C81.824 585 60 563.176 60 536.25v-142.5C60 366.824 81.824 345 108.75 345Zm0 0"
      style={{ stroke: 'none', fillRule: 'nonzero', fill: 'url(#pp_j)' }}
    />
    <path

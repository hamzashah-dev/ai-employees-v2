...
interface AppearanceTrayProps {
  editor: UseIdentityEditorResult
  /** Closes whatever is holding the tray. */
  onDone: () => void
}
 ...
 * control almost nobody touches. Putting them behind a deliberate open puts the employee
 * first and the paint job second.
 *
 ...
 */
export const AppearanceTray: FC<AppearanceTrayProps> = ({ editor, onDone }) => (
    ...
    <div className="flex flex-wrap items-center justify-between gap-2">
      ...
      */}
      ...
      <div className="flex shrink-0 items-center gap-1">
        ...
        <Button type="button" variant="primary" size="xs" onClick={onDone}>
          Done
        </Button>
      </div>
    </div>
